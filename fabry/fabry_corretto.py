...
if __name__ == "__main__":
    ...
    distanze_file = curr_dir / "distanze_fabry.txt"
    multi_file = curr_dir / "multimetro_fabry.txt"
    multi_sigma_file = curr_dir / "multimetro_sigma_fabry.txt"

    with open (distanze_file) as file_distanze:
        distanze = [float (x) for x in file_distanze.readlines ()]

    with open (multi_file) as file_multimetro:
